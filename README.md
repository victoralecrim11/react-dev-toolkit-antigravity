# React Dev Hub Plugin — Antigravity Edition — v1.3.4
...
- [React Dev Hub Plugin — Antigravity Edition — v1.3.4](#react-dev-hub-plugin--antigravity-edition--v134)
  - [Indice](#indice)
...
- [O que mudou na v1.3.4](#o-que-mudou-na-v134)
...
<a id="o-que-mudou-na-v134"></a>
## O que mudou na v1.3.4

- **Commit:** fix: correcao comportamental rigorosa no orquestrador e quality gate
...
- **Commit:** chore: homologar camada agentica compatível
- **Automação de changelog.** `scripts/bump-version.py` agora cria esta seção automaticamente no `README.md` durante o bump de versão.
...
- **Commit:** docs: atualizar nome do plugin para react-dev-toolkit-antigravity
- **Automação de changelog.** `scripts/bump-version.py` agora cria esta seção automaticamente no `README.md` durante o bump de versão.

<a id="o-que-mudou-na-v127"></a>
## O que mudou na v1.2.7

- **Commit:** feat: adicionar as 7 features do dashboard e testes E2E
- **Automação de changelog.** `scripts/bump-version.py` agora cria esta seção automaticamente no `README.md` durante o bump de versão.

<a id="o-que-mudou-na-v126"></a>
## O que mudou na v1.2.6

- **Commit:** chore(ci): ajusta bump-version.yml para novo fluxo de release
- **Automação de changelog.** `scripts/bump-version.py` agora cria esta seção automaticamente no `README.md` durante o bump de versão.
