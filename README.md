...
- **Commit:** feat(agentic): consolidar arquitetura root-routed na v1.4.0
...
- **Commit:** fix: erradica falha na construcao do executor de subagents no runtime do Antigravity
- **Automação de changelog.** `scripts/bump-version.py` agora cria esta seção automaticamente no `README.md` durante o bump de versão.
