...
3. Cruze a intenção documentada (`PROJECT.md`, `REQUIREMENTS.md`, `ROADMAP.md`, `STATE.md`, `phases/XX-YY-PLAN.md` versus `XX-YY-SUMMARY.md`) com o código real, usando:
   ...
   * `.design/design-system.md` (se existir na raiz do projeto) como critério primário de aderência de tokens visuais. Fallback: `./skills/ui-ux/data/colors.csv` e `styles.csv`.
