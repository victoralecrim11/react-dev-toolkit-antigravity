...
Avalie tipos, erros, loading e empty states, acessibilidade, responsabilidades, performance (re-renderizacoes, cache, data-fetching e N+1, bundle), casos de borda, testes e divida tecnica. Classifique por prioridade e explique o motivo.
